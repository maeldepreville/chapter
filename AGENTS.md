...
- La version Sites 30 est une base de recette, pas un jalon validé. Les candidats postérieurs au commit GitHub `9547a2a` ne doivent pas être envoyés sur GitHub avant validation du jalon regroupé.
