...
Phases 1 through 11, lot 1 and the P0–P7 pre-lot-2 redesign are complete. Sites version 84 is the accepted live baseline on GitHub `main`. Backend lot 2 remains to be framed before implementation.
