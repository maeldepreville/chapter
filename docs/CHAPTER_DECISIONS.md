...
**Suite actuelle : volet 4 constitué puis repris après recette, correctif P11-F32 publié en version Sites 28.** Le 27 août 2026, « Je valides avec AM1. Continuons. » valide le **fondu seul**, sans déplacement des surfaces. Le 1er septembre, l'utilisateur autorise l'implémentation immédiate des correctifs diagnostiqués et révise la méthode future. **P11-F18 à F21 sont traités dans le dépôt candidat :** verso isolé, faces étanches, coordonnées tactiles adaptées et continuité pincement → glissement. **P11-F22 à F27** traitent le reflow et les contrôles accessibles. **P11-F28 à F30** renforcent le verso mobile, harmonisent « Suivre/Suivi » et remplacent la croix native par « Effacer ». **P11-F31** réduit la zone de persistance de la fiche d'honneur ; **P11-F32** rétablit l'accès à ses actions en traitant le badge, l'intervalle et la fiche comme une même zone interactive précise. Le clic, le clavier et le toucher conservent leur ouverture persistante. Le volet 4 vérifie aussi les liaisons Découvrir/profil/liste/honneurs, statut/date/Journal et ajout/annulation. PFP1, QR1, QRM1b, QRP1b, HDE1, HMT1, les assets et CT1 restent inchangés. **Build de production, lint, `git diff --check` et 92/92 tests réussis.** La version Sites 28 remplace la version 27 comme base visible. Ces publications de recette ne valident pas le jalon et ne synchronisent pas GitHub. La recette à 200 % de texte, Safari mobile, desktop étroit, clavier et technologies d'assistance reste indispensable ; aucune conformité WCAG globale n'est revendiquée. Le bilan candidat est dans `PHASE_11_BILAN_ET_CLOTURE.md`.
