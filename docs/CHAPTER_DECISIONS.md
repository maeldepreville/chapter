...
- Phase 11 — états transversaux, cohérence, responsive et accessibilité : **trois ensembles validés et implémentés, vérifications techniques réussies ; publication différée au jalon regroupé demandé par l'utilisateur**. La recette navigateur reste à effectuer. Les animations sont situées dans le volet cohérence/accessibilité. Le plan initial s'arrête à cette consolidation ; l'authentification, l'onboarding et les autres fonctions exclues nécessiteront un périmètre ultérieur explicitement validé.
...
La question de l'utilisateur sur les animations est située dans le volet 3 de la phase 11, cohérence et accessibilité, avant la vérification finale. Les retours fonctionnels S2 et le retournement QRM1b sont déjà validés ; le travail restant consiste à discuter l'harmonisation des transitions, leur rythme et les alternatives à mouvement réduit. Aucun nouvel effet ni refonte n'est autorisé à ce stade.
