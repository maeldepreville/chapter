...
- Phase 11 — états transversaux, cohérence, responsive et accessibilité : **premier ensemble accepté ; deuxième ensemble validé et implémenté, vérifications techniques réussies ; publication différée au jalon regroupé demandé par l'utilisateur**. La recette navigateur reste à effectuer. Les animations sont situées dans le volet cohérence/accessibilité. Le plan initial s'arrête à cette consolidation ; l'authentification, l'onboarding et les autres fonctions exclues nécessiteront un périmètre ultérieur explicitement validé.
...
À la demande de poursuite, le troisième ensemble est **proposé, non autorisé** : ordre fiable des imports photo, erreurs de recadrage récupérables, copie/partage sans chevauchement et écrits longs lisibles. Des diagnostics avec doublures reproduisent un ancien import remplaçant le dernier, une exception d'export sans alerte, un échec du repli de copie sans nettoyage, deux partages simultanés et une critique longue sans « Lire la suite ». Le risque CSS des paragraphes/chaînes longues est relevé sans test visuel. Les constats P11-F10 à F15 et la proposition figurent dans le suivi de phase. Seule la documentation change ; PFP1, N1b, QRP1b, QRM1b, les assets et la limite de 3 000 caractères restent conservés. Les 49 tests et le build cités ci-dessus sont ceux du deuxième ensemble, pas de nouvelles vérifications exécutées dans ce tour.
