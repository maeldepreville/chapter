...
- Phase 11 — états transversaux, cohérence, responsive et accessibilité : **candidat technique du jalon regroupé constitué**. Trois ensembles puis AM1 sont validés et implémentés ; CT1 est refusé ; les correctifs de carte/gestes et de reflow/contrôles restent à évaluer. Le volet 4 ajoute la non-régression des parcours racine, le bilan et la checklist de clôture. La publication et la synchronisation restent différées, la recette navigateur reste à effectuer et le lot 1 n'est pas encore déclaré clos. Le plan initial s'arrête à cette consolidation ; l'authentification, l'onboarding et les autres fonctions exclues nécessiteront un périmètre ultérieur explicitement validé.
...
**Suite actuelle : volet 4 constitué puis repris après recette, version Sites 26 disponible pour une nouvelle évaluation.** Le 27 août 2026, « Je valides avec AM1. Continuons. » valide le **fondu seul**, sans déplacement des surfaces. Le 1er septembre, l'utilisateur autorise l'implémentation immédiate des correctifs diagnostiqués et révise la méthode future. **P11-F18 à F21 sont traités dans le dépôt candidat :** verso isolé, faces étanches, coordonnées tactiles adaptées et continuité pincement → glissement. **P11-F22 à F27 sont également traités comme candidats :** contraste non textuel des champs et du focus, reflow des actions/titres/formulaires, repère de focus du sélecteur de fichier, groupe d'étoiles à tabulation unique et flèches circulaires, avatars non fonctionnels rendus statiques, destination courante et relations de contrôles annoncées. Une nouvelle capture utilisateur conduit aux reprises **P11-F28 à F30** : corps du verso mobile autonome et centré, bouton « Suivre/Suivi » identique dans profil/Découvrir/listes, croix native de recherche remplacée par « Effacer ». Le volet 4 vérifie aussi les liaisons Découvrir/profil/liste/honneurs, statut/date/Journal et ajout/annulation. PFP1, QR1, QRM1b, QRP1b, les assets et CT1 restent inchangés. **Build de production, lint final, `git diff --check` et 91/91 tests réussis.** À la demande explicite de visualisation, le commit candidat `4d225a642d2f362f6595d67ae43a843f9033de97` est déployé en version Sites 26 sur l'URL habituelle, en accès propriétaire. Cette publication de recette ne valide pas le jalon et ne synchronise pas GitHub. La recette à 200 % de texte, Safari mobile, desktop étroit, clavier et technologies d'assistance reste indispensable ; aucune conformité WCAG globale n'est revendiquée. Le bilan candidat est dans `PHASE_11_BILAN_ET_CLOTURE.md`.
...
**Décision de publication révisée :** le 27 août 2026, l'utilisateur demande d'abord de poursuivre plusieurs étapes sans déployer la version 25. Le 1er septembre, après constitution et reprise du jalon regroupé, il demande explicitement que les correctifs soient visibles sur le Site. La version 26 est donc déployée pour recette ; cette autorisation remplace l'interdiction de publication pour ce candidat uniquement. La synchronisation GitHub des éléments validés demeure distincte et aucune validation utilisateur n'est déduite du déploiement.
