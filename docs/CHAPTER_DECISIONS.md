...
**Dernière décision, prioritaire sur les instructions historiques ci-dessous :** le 27 août 2026, l'utilisateur valide les changements du premier ensemble, mais demande de poursuivre d'autres étapes avant de publier un jalon regroupé. Ne pas déployer la version 25 ni demander sa publication immédiate. La version en ligne reste inchangée ; la synchronisation GitHub des éléments validés demeure distincte. Cet accord ne vaut pas exécution d'une recette navigateur.
