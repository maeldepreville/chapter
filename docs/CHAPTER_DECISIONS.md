...
**Décision de publication révisée :** le 27 août 2026, l'utilisateur demande d'abord de poursuivre plusieurs étapes sans déployer la version 25. Le 1er septembre, après constitution et reprise du jalon regroupé, il demande explicitement que les correctifs soient visibles sur le Site. La version 26 est donc déployée pour recette, puis remplacée par la version 27 intégrant P11-F31 ; cette autorisation remplace l'interdiction de publication pour ces candidats de recette. La synchronisation GitHub des éléments validés demeure distincte et aucune validation utilisateur n'est déduite du déploiement.
