...
**Suite actuelle : volet 4 constitué puis repris après recette, nouveau candidat Sites en préparation.** Le 27 août 2026, « Je valides avec AM1. Continuons. » valide le **fondu seul**, sans déplacement des surfaces. Le 1er septembre, l'utilisateur autorise l'implémentation immédiate des correctifs diagnostiqués et révise la méthode future. **P11-F18 à F21 sont traités dans le dépôt candidat :** verso isolé, faces étanches, coordonnées tactiles adaptées et continuité pincement → glissement. **P11-F22 à F27** traitent le reflow et les contrôles accessibles. **P11-F28 à F30** renforcent le verso mobile, harmonisent « Suivre/Suivi » et remplacent la croix native par « Effacer ». **P11-F31** fait disparaître la fiche d'honneur dès la sortie du badge en simple survol, tout en conservant une ouverture persistante au clic, au clavier et au toucher pour ses actions. Le volet 4 vérifie aussi les liaisons Découvrir/profil/liste/honneurs, statut/date/Journal et ajout/annulation. PFP1, QR1, QRM1b, QRP1b, HDE1, HMT1, les assets et CT1 restent inchangés. **Build de production, lint final, `git diff --check` et 92/92 tests réussis.** La version Sites 26 sert de base de recette et sera remplacée par le candidat incluant P11-F31. Ces publications de recette ne valident pas le jalon et ne synchronisent pas GitHub. La recette à 200 % de texte, Safari mobile, desktop étroit, clavier et technologies d'assistance reste indispensable ; aucune conformité WCAG globale n'est revendiquée. Le bilan candidat est dans `PHASE_11_BILAN_ET_CLOTURE.md`.
