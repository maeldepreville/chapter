...
- Phase 11 — états transversaux, cohérence, responsive et accessibilité : **ouverte le 27 août 2026 ; premier ensemble de correctifs validé et autorisé, implémentation en cours**. Le plan initial s'arrête à cette consolidation ; l'authentification, l'onboarding et les autres fonctions exclues nécessiteront un périmètre ultérieur explicitement validé.
