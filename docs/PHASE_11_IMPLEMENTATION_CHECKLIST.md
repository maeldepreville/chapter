...
- [ ] Après validation seulement : vérifier la mise à jour du bilan, la synchronisation GitHub du commit accepté, puis décider séparément d'une publication Sites.
