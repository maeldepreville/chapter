...
- [ ] Après validation seulement : vérifier la mise à jour du bilan et la synchronisation GitHub du commit accepté. La version Sites 27 étant déjà le support de recette, ne décider d'une nouvelle publication que si une reprise supplémentaire la rend nécessaire.
