...
- **Phase active :** refonte visible pré-lot 2 — candidate P6 auditée visuellement sur Sites 71. `main` attend P7.
...
- **Statut P6 :** candidate Sites 71 : états vides affinés après navigation complète, couvertures cohérentes, petites surfaces sans flash, grandes cartes mobiles détourées et débordement Recherche fermé. Les 162 tests, lint, construction, diff et audit navigateur réussissent ; validation requise avant synchronisation.
