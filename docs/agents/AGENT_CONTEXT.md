...
- **Phase active :** refonte visible pré-lot 2 — P5 audité sur le Site : Profil recentré, identité unifiée, import privé et navigation sans superposition ni auto-empilement. P0 à P4 validés ; P5 reste hors GitHub et `main` attend P7.
