...
- **Phase active :** refonte visible pré-lot 2 — P5 publiée sur Sites 54, en recette. Coque connectée dès la création du compte et Profil propriétaire réchauffé ; P0 à P4 sont validés, P5 reste hors GitHub et `main` attend P7.
