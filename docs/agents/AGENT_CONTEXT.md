...
- **Phase active :** refonte visible pré-lot 2. P1 — Premier contact public est validé sur la version Sites 34 et synchronisé sur GitHub. La candidate P2 — Premier repère est complète et prête pour recette sur le Site existant ; sa validation et sa synchronisation GitHub restent en attente.
...
- **Recette P2 :** les fonctionnalités initiales sont jugées fonctionnelles. La correction candidate reprend l’ouverture de Recherche avec un atlas graphique diffus, rétablit le panneau AJ2 au-dessus du voile mobile et contient désormais le croquis comme la feuille d’inscription dans le viewport mobile. P2 reste non validé et non synchronisé sur GitHub.
