...
- **Recette P2 :** les fonctionnalités initiales sont jugées fonctionnelles. Une correction candidate reprend l’ouverture de Recherche avec un atlas graphique diffus et rétablit le panneau AJ2 au-dessus du voile mobile. P2 reste non validé et non synchronisé sur GitHub.
