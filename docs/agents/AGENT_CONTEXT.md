...
- **Phase active :** refonte visible pré-lot 2 — candidate P5 ajustée publiée sur Sites 53, en attente de recette. P0 à P4 sont validés ; P5 reste hors GitHub avant validation et `main` attend P7.
