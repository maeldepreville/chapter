...
- **Phase active :** refonte visible pré-lot 2 — P5 publiée sur Sites 57, en recette. Navigation stable dès la création du compte et Profil recomposé autour d'une aquarelle fondue en haut à droite ; P0 à P4 validés, P5 reste hors GitHub et `main` attend P7.
