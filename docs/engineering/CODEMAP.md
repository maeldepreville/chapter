...
Cette carte sert à ouvrir les bons symboles sans charger les deux grands composants applicatifs en entier. Elle décrit la candidate P0 locale construite au-dessus de la base acceptée du lot 1. Le contrat du jalon est dans [`P0_FONDATIONS_PROTOTYPE.md`](../milestones/P0_FONDATIONS_PROTOTYPE.md).
