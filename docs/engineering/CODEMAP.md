...
| Fondation candidate de la page œuvre | `PublicWork` dans `app/p1-public.tsx`, vue œuvre dans `app/page.tsx` | `app/recette/oeuvre/work-recipe-lab.tsx`, `work-recipe.css`, `p1-public.css`, `globals.css` | `work-foundation`, `p4-social`, `phase11-accessibility`, `phase11-empty-states` |
