...
| Fondation candidate de la page œuvre | `PublicWork` dans `app/p1-public.tsx`, vue œuvre dans `app/page.tsx` | `work-section-nav.tsx` (sommaire, ancres et garde des fragments communs), `book-work-cover.tsx`, `work-past-notes.tsx`, `app/recette/oeuvre/work-recipe-lab.tsx`, `p1-public.css`, `globals.css` | `work-foundation`, `p4-social`, `phase11-accessibility`, `phase11-empty-states` |
