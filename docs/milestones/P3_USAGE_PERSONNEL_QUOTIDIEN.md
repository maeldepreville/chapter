...
La première candidate conservait trop de la composition historique. La reprise applique une coquille personnelle harmonisée, relie Découvrir et Recherche aux surfaces refondues, distingue lectures actives, feuille de dernière trace et archives, densifie la Bibliothèque et redessine le repère comme un signet vertical. Le nouveau lecteur conserve un état vierge, distinct de la persona dense. Le retour contextuel restaure la position. Recette utilisateur attendue.
