...
- l'export et l'import réussis ouvrent une carte éditoriale dédiée, refermable par croix ou clic extérieur : l'import propose de vérifier les lectures dans la Bibliothèque, l'export de revenir au Journal. Une archive invalide conserve son explication contextualisée dans la section `Vos données`.
