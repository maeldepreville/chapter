...
- P4 — Dimension sociale possède une première candidate le 6 septembre 2026. La page d’œuvre publique porte désormais les critiques et conversations ; auteurs, profils, listes et résultats de Recherche forment un parcours public continu. Publier, répondre ou suivre déclenche au premier geste une identité minimale, puis restitue l’action sans publication implicite. Cette candidate reste en recette : elle ne vaut ni validation ni synchronisation GitHub. Le détail actif est dans [`P4_DIMENSION_SOCIALE.md`](../milestones/P4_DIMENSION_SOCIALE.md).
