...
- Candidate P6 du 9 septembre 2026 : les routes publiques inconnues n'affichent plus une entité de remplacement ; Chapter possède des frontières globales de chargement, erreur récupérable et page absente. Le clavier dispose d'un lien d'évitement et d'une cible principale focalisable, Recherche expose son état courant et le mouvement réduit neutralise aussi le squelette. L'atelier isolé `/recette/p6` rend observables les états normal, vide, chargement, erreur et contenus extrêmes sans rejoindre la navigation produit. Après recette, la version Sites 69 corrige le flash des petites surfaces, généralise la hiérarchie et le contraste des couvertures, puis borne les traces du Profil. L'audit navigué suivant produit la version Sites 70 : Journal, Bibliothèque, Découvrir et Recherche disposent de seuils vides contextualisés sans action morte, Profil et listes conservent leur intention éditoriale sans contenu, et le débordement horizontal du croquis de Recherche est fermé. Elle attend une validation explicite avant toute synchronisation GitHub ; le détail et la checklist vivent dans [`P6_ETATS_TRANSVERSAUX.md`](../milestones/P6_ETATS_TRANSVERSAUX.md).
