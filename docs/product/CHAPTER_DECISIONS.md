...
- Clôture P7 du 12 septembre 2026 : après l’audit navigateur final, l’utilisateur valide explicitement la refonte visible pré-lot 2, puis autorise explicitement sa publication et sa fusion vers le `main` GitHub public. La version Sites 84 aligne définitivement Réglages et création de compte sur « Nom de lecteur », destiné à être unique sur Chapter et limité à 40 caractères. Les six parcours P7, les cinq états P6, les notifications indépendantes, les suppressions réversibles, les états vides, la curation depuis la Bibliothèque, « Vous » et la projection unique de l’avatar sont couverts par 177/177 tests, le lint, la construction de production, `git diff --check` et l’inspection navigateur. Le lot 2 backend reste un cadrage séparé.
