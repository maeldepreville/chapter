...
- Candidate P6 du 9 septembre 2026 : les routes publiques inconnues n'affichent plus une entité de remplacement ; Chapter possède des frontières globales de chargement, erreur récupérable et page absente. Le clavier dispose d'un lien d'évitement et d'une cible principale focalisable, Recherche expose son état courant et le mouvement réduit neutralise aussi le squelette. L'atelier isolé `/recette/p6` rend observables les états normal, vide, chargement, erreur et contenus extrêmes sans rejoindre la navigation produit. Après la première recette, la version Sites 68 sépare strictement titre et auteur sur les couvertures typographiques, corrige à la racine le flash de fermeture des petites surfaces partagées et rend les traces publiques longues du Profil dépliables. Elle attend une validation explicite avant toute synchronisation GitHub ; le détail et la checklist vivent dans [`P6_ETATS_TRANSVERSAUX.md`](../milestones/P6_ETATS_TRANSVERSAUX.md).
